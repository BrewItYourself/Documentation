...
\noindent This satisfies the functional requirement "Application Notification" seen in the Functional Specification section \ref{FS}, where the system can provide notifications to the user simply by calling the URL with the message that it wants the user to receive.
