...
The risks were mitigated by taking precautions before using the system. Insulators, heat syncs and fans was appropriated used to avoid injury.

One of the problems that was faced during the implementation was getting rid of the by-products that gets created during the brew process. This problem was solved by integrating a waste removal system as seen in Section \ref{sec:waste-removal}.
