...
Of the four controllable subsystems, the heating and cooling for fine temperature regulation is the highest priority for robust design. The pump and actuators are necessary for the final realized system, but can easily be constructed with off-the-shelf components and minimal design effort.
...
\appendix
%Appendix A
\includepdf[scale=0.9,pages=1,pagecommand=\section{Appendix}]{forms/symposium_prototype_hazard_disclosure_form.pdf}

%Appendix B
\includepdf[scale=0.9,pages=1,pagecommand=\section{Appendix}]{forms/symposium_floor_plan_request_form.pdf}
